...
{
    public class SPECIAL_SPEAKER_ESSENCE : ICloneable
    {
        ...
        public COMMON.ChatChannel channal { get; set; }
        public COMMON.BOOL only_faction_master { get; set; }
        public int occupy_region { get; set; }
        public int occupy_city { get; set; }
