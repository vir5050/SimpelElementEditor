...
{
    public class REVIVESCROLL_ESSENCE : ICloneable
    {
        ...
        public float hp_resume { get; set; }
        public float mp_resume { get; set; }
        public float vp_resume { get; set; }
        public float exp_consumed { get; set; }
        public float sp_consumed { get; set; }
