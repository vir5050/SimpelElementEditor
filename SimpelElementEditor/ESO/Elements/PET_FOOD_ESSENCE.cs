...
{
    public class PET_FOOD_ESSENCE : ICloneable
    {
        ...
        public int pet_level_required { get; set; }
        public int pet_food_type { get; set; }
        public int food_usage { get; set; }
        public int food_value { get; set; }
        public int cool_time { get; set; }
        public COMMON.BOOL use_once { get; set; }
